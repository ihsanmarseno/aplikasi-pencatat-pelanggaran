...
//  inisialisasi
    ...
    TextView totalPelanggaranOutput, kategoriJumlahPelanggaranOutput;
    ImageView imgempty;
    TextView txtkosong;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kategoriJumlahPelanggaranOutput = findViewById(R.id.kategoriJumlahPelanggaran);
        ...
        int totalPelanggaran = Integer.parseInt(totalPelanggaranOutput.getText().toString());

        // Tentukan kategori berdasarkan jumlah pelanggaran
        String kategori;
        if (totalPelanggaran > 1000) {
            kategori = "Kategori : Tinggi";
        } else if (totalPelanggaran > 500) {
            kategori = "Kategori : Sedang";
        } else {
            kategori = "Kategori : Rendah";
        }

        // Tampilkan kategori di TextView
        kategoriJumlahPelanggaranOutput.setText(kategori);
